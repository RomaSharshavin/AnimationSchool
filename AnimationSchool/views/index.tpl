...
<head>
    ...
    <link rel="stylesheet" href="static/content/StylesHomePage.css">
    <style>
        body {
...
<body>
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <h2></h2>
            <p>
                The <b>Children's Animation School</b> provides you with a powerful tool for creating dynamic websites,
                ensuring clean separation of concerns and full control over the markup for pleasant and flexible development.
            </p>
        </div>
    </div>
